        ...
        public IEnumerable<Bicycle> Bicycles
        {
            get
            {
                return new List<Bicycle> {
                    new Bicycle{name = "A-52", shortDesc = "A reliable mountain bike", longDesc = "A-52 is perfect for off-road adventures with durable construction and superior handling.", img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpLB2l6UXlqixi1D3y6S2En3ECwVnVcNUFOQ&s", price = 444, isFavorite = true, available = true, category = _categoryBicycle.AllCategories.First()},
                    new Bicycle{name = "Roadster", shortDesc = "A sleek road bike", longDesc = "Roadster offers unmatched speed and performance on paved surfaces.", img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRn33TQ27UleJ7RpEIUaQF6WIBFDTg5bvGk7g&s", price = 599, isFavorite = true, available = true, category = _categoryBicycle.AllCategories.First()},
                    new Bicycle{name = "EcoBike", shortDesc = "Eco-friendly city bike", longDesc = "EcoBike is designed for urban commuting with a lightweight frame and eco-friendly materials.", img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdpvHUfEwFBAOoI6PZVowGHmwtt0tzx0_Mmg&s", price = 350, isFavorite = false, available = true, category = _categoryBicycle.AllCategories.First()},
                    new Bicycle{name = "Cruiser", shortDesc = "Comfortable cruiser bike", longDesc = "Cruiser provides a relaxed riding experience with its comfortable seat and smooth handling.", img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNlQ2WsmfBE6HQFrp9W2NRnoldlfJiuPJuZg&s", price = 275, isFavorite = false, available = true, category = _categoryBicycle.AllCategories.First()},
                    new Bicycle{name = "TrailBlazer", shortDesc = "All-terrain trail bike", longDesc = "TrailBlazer is built for rugged trails with robust features for ultimate durability.", img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9-En5rQxvyCrIg3BXvkxA18usaOEx8kPyxQ&s", price = 499, isFavorite = true, available = true, category = _categoryBicycle.AllCategories.First()},
                    new Bicycle{name = "Speedster", shortDesc = "High-speed racing bike", longDesc = "Speedster is engineered for competitive racing with advanced aerodynamics and high-end components.", img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqKyqIjWBW9J1CB3BKNRBo3cf_8fR9bpZD4g&s", price = 899, isFavorite = true, available = true, category = _categoryBicycle.AllCategories.First()}
                };
            }
        }
